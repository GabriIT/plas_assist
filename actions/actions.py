...
class ActionPlayRPS(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if user_choice == "transparent":
            dispatcher.utter_message(
                text="Congrats, you selected a Diamond Material")
        if user_choice == "metal replacement":
            dispatcher.utter_message(
                text="Congrats, you selected GRIVORY IRON")
        if user_choice == "sanitary":
            dispatcher.utter_message(
                text="Congrats, you selected VICTORIA EXCELLENCE")
